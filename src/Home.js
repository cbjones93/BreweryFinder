        ...
        <>
            <div className='homeDetails'>
                ...
                <div className="home-intro">
                    ...
                    <p>
                        When you have created your profile, you can start off with our <Link className="navbar__link" to="/brewerysearch">BreweryFinder</Link>&trade;. </p>
                    ...
                    {!(currentUser > 0)  ?
                     ...
                     :
                        <p>
                            You can also follow other users to keep track of their favorite breweries as well as see their reviews from them. To follow a user you can either add them from a brewery's review section, or to search for them by name. To see your following list click <Link className="navbar__link" to="/follow">Here</Link>
                        </p>
}
                    <p>
